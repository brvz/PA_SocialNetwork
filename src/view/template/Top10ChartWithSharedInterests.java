...
public class Top10ChartWithSharedInterests extends ChartsTemplate {
    ...
    public Top10ChartWithSharedInterests(SocialNetwork sn) {
        this.sn = sn;
        this.top10 =  sn.getTop10With();
    }

    @Override
    public String getTitle() {
        return "Top 10 with Most Shared Relationships";
    }
    ...
    public void addData(XYChart.Series series1) {
        ...
        for(int i = 0; i < list.size(); i++){
            if(aux < 10){
                series1.getData().add(new XYChart.Data(String.valueOf(list.get(i).getNumber()), sharedInterest(list.get(i))));
                aux++;
            }
    ...
    public int sharedInterest(User u){
        int count = 0;
